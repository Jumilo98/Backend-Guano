...
import { getAllUsuarios, getUsuarioById , getOnlyUsuarios, createUsuario , updateUsuario , deleteUsuario, getUsersByEmail} from '../Controllers/usuario.controller.js'
...
router.get('/usuario/email/:email_user', getUsersByEmail);
